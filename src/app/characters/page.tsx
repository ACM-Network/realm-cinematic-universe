      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-20 select-none">
        ...
        <section className="mt-24 pt-16 border-t border-white/[0.03]">
          <div className="text-center mb-12">
            ...
            <p className="text-[10px] uppercase tracking-[0.15em] text-slate-550 mt-2">Interactive SVG Link Matrix. Click node names to select folder files.</p>
          </div>
